...
test.describe('Submit Delivery', ()=> {
   ...
   //   });
     ...
     test.skip('Submit Delivery - Optimize', async ({ page }) => {
        ...
        test.only('Select Optimize type', async ({ page }) => {
         ...
         var _count =  page.getByRole('row', { name: '3D Coordination Foundation (Buildings) OPTIMIZE QAtest3 Unavailable Mar 28,' }).getByRole('button').count
         console.log(_count)
